/*
    ...
    @param angulo_radianos Recebe a medida de um ângulo em radianos
    @return Retorna o seno de angulo_radianos
...
/*
    ...
    @param angulo_radianos Recebe a medida de um ângulo em radianos
    @return Retorna o cosseno de angulo_radianos
...
/*
    ...
    @param angulo_radianos Recebe a medida de um ângulo em radianos
    @return Retorna a tangente de angulo_radianos
